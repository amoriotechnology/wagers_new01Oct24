      ...
      <div class="panel-title">
         <div id="block_container">
            ...
            <div id="bloc2" style="float:right;">
               ...
               <a  href="<?php echo base_url('Cinvoice/manage_profarma_invoice') ?>" class="btnclr btn  m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('Manage Quotation') ?> </a>
               <?php// }?>
            </div>
         </div>
      </div>
      ...
      <div class="row">
         <div class="col-sm-6">
            <div class="form-group row">
               ...
               <div class="col-sm-8">
                  <select class="selectpicker countrypicker form-control"  data-live-search="true" data-default="United States"  name="country_goods" id="shipping_line" style="border: 2px solid #d7d4d6;width:100%" ></select>
               </div>
            </div>
         </div>
         <div class="col-sm-6">
            <div class="form-group row">
               ...
               <div class="col-sm-8">
                  <select class="selectpicker countrypicker form-control" data-live-search="true" data-default="United States" id="container_no" name="country_destination" placeholder="Country of final destination" style="border: 2px solid #d7d4d6;width:100%" ></select>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="table-responsive">
            ...
            <table class="table normalinvoice table-bordered table-hover" id="normalinvoice_1" style="border: 2px solid #d7d4d6;" >
               ...
               <tbody id="addPurchaseItem_1">
                  <tr>
                     ...
                     <td>
                        <span class="input-symbol-euro"><input type="text" id="cost_sq_ft_1"  name="cost_sq_ft[]" readonly  style="width:70px;"  placeholder="0.00"   class="cost_sq_ft form-control" ></span>
                     <td >
                        <span class="input-symbol-euro"> <input type="text"  id="cost_sq_slab_1" name="cost_sq_slab[]" readonly   style="width:70px;"   placeholder="0.00"  class="cost_sq_slab form-control"/></span>
                     </td>
                     <td>
         ...
         <table class="taxtab table table-bordered table-hover"    style="border: 2px solid #d7d4d6;"     >
            <tr>
               ...
               <td  style="width:20%;"><a href="#" class="client-add-btn btn btnclr" aria-hidden="true" style="margin-right: 295px;"  data-toggle="modal" data-target="#proforma_taxinfo" ><i class="fa fa-plus"></i></a></td>
            </tr>
         </table>
         <table border="0"   class="overall table table-bordered table-hover" style="border: 2px solid #d7d4d6;table-layout: auto;" >
            ...
            <tr>
               ...
               <td colspan="4" style="width:250px;text-align:right;border:none;"><b><?php echo display('TAX DETAILS')?> :</b></td>
